package cn.lyj.middleware.methodext;

import cn.lyj.middleware.methodext.annotation.DoMethodExt;
...
public class DoMethodExtPoint {
    ...
    @Pointcut("@annotation(cn.lyj.middleware.methodext.annotation.DoMethodExt)")
